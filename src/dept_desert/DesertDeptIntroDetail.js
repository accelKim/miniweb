    ...
    return (
        <div>
            <div className="top_box">
                <p>Department of Dessert & Culinary Arts</p>
                <div className="top_box_title">디저트·조리학부</div>
                <div className="top_box_text">
                21세기 미래 선도 산업으로 주도적인 역할을 담당할 수 있는 서비스 마인드와 기본 소양을 갖춘 인재교육과 외식산업현장에서 필요한 전문지식과 기술을 겸비한<br />
