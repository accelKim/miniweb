        ...
        <div className="cosmetology_edgoals">
            <div className="major_bottom_content">
                ...
                <div className="major_career">
                    <ul>
                        <li>- 인간존중의 가치 실현과 행복 나눔을 실천할 수 있는 통합적 인성교육 강화</li>
                        <li>- 꿈의 실현을 통해 행복한 삶을 찾아갈 수 있는 진로교육 강화</li>
                        <li>- 수요자 중심의 교육과정 편성을 통한 산업체 맞춤형 인재 양성</li>
                        <li>- 예술성과 전문성이 어우러진 융합교육을 통한 21C형 창의적 인재 양성</li>
                        <li>- 디지털 미디어 교육을 통한 미래지향형 인재 양성</li>
                    </ul>
                    <p><br /></p>
                </div>
            </div>
